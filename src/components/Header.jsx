...
export const TextContent = () => {
  return (
    <div align='center' style={{ justifyContent:'center', maxWidth: '500px' , }}>
        <Typography variant='h3'>
            Handsbags
            <Fab><MoreHorizIcon /></Fab>
        </Typography>
       <IconButton>
        <img src="https://i.pinimg.com/280x280_RS/f6/1d/af/f61daf16a484e55fbf637b8757bbbbe6.jpg" alt='logo' width='30px' style={{borderRadius: '15px', overflow: 'hidden'}}/>
       </IconButton>
       ...
       <br/>
        <Button  sx={{ borderRadius: '24px', padding:'22px !important',fontWeight:'800'}} >Share</Button>
    </div>
  )
}